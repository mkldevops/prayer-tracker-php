 ...
 */
final class Version20200509125213 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('INSERT INTO prayer (id, prayer_name_id, objective_id, user_id, created_at, updated_at, accomplished_at) SELECT id, prayer_name_id, program_id, user_id, created_at, updated_at, accomplished_at FROM __temp__prayer');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE prayer');
        $this->addSql('CREATE TABLE prayer (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, prayer_name_id INTEGER NOT NULL, user_id INTEGER NOT NULL, accomplished_at DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, program_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO prayer (id, prayer_name_id, program_id, user_id, accomplished_at, created_at, updated_at) SELECT id, prayer_name_id, objective_id, user_id, accomplished_at, created_at, updated_at FROM __temp__prayer');
        $this->addSql('DROP TABLE __temp__prayer');
        $this->addSql('CREATE INDEX IDX_47C953865E02C9F9 ON prayer (prayer_name_id)');
        $this->addSql('CREATE INDEX IDX_47C95386A76ED395 ON prayer (user_id)');
